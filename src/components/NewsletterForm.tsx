  ...
  return (
    <div className="border rounded-md p-5 w-full">
      ...
      <div className="flex flex-col md:flex-row lg:flex-col gap-2 mt-7">
        ...
        />
        <button className="w-full md:w-1/2 lg:w-full bg-primary text-white rounded-md text-sm font-semibold flex-none shadow-sm shadow-primary/50 hover:shadow-lg hover:shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/20 px-8 py-3">
          Subscribe
        </button>
      </div>
