...
export const metadata: Metadata = {
  title: 'Talks - Tosin Amuda',
  description: 'Speaking engagements and talks by Tosin Amuda',
};
    ...
    <>
      <section className="bg-gradient-to-t from-fuchsia-500/10 lg:pt-28 sm:pb-36 pb-16 pt-36 relative">
          ...
          <div className="flex justify-center">
            <div className="lg:w-7/12 text-center">
              ...
              <p className="mb-6 md:text-lg text-gray-500">
                If you&apos;re interested in having me speak at an event you are organizing, please
                send me a message via{' '}
                <a target="_blank" href="https://twitter.com/tosinamuda">
                  Twitter
                </a>
                . I&apos;m always happy to talk about: AI Engineering (Applied LLM & Conversational
                AI), Typescript, Python, Engineering Best Practices, and Design Thinking and more.
                Thanks! 😊
              </p>
            </div>
          </div>
        ...
        <div className="absolute -bottom-1 w-full">
          <img className="w-full h-full" src="/images/svg/shape.svg" alt="" />
        </div>
      </section>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>25 March, 2022</td>
                  <td>
                    <a target="_blank" href="https://www.youtube.com/watch?v=9BaVjwqUZME">
                ...
                <tr>
                  ...
                  <td>03 Dec, 2020</td>
                  <td>
                    <a target="_blank" href="https://www.crowdcast.io/e/deploy-your-first-app">
                ...
                <tr>
                  ...
                  <td>24 Nov, 2020</td>
                  <td>
                    <a target="_blank" href="https://www.crowdcast.io/e/ai-nodejs">
                ...
                <tr>
                  ...
                  <td>30 Oct, 2020.</td>
                  <td>
                    <a target="_blank" href="https://www.crowdcast.io/e/unodc-ea-hackathon--">
                ...
                <tr>
                  <td>
                    <a target="_blank" href="https://www.meetup.com/ZA-IBMCloud/events/271239126/">
                ...
                <tr>
                  ...
                  <td>4 Oct, 2019</td>
                  <td>Building Blockchain Apps using IBM Blockchain Platform</td>
                  <td>Abuja, 🇳🇬</td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>14 Sep, 2019</td>
                  <td>Building Serverless API for JAMStack Web App using IBM Cloud Functions</td>
                  <td>Lagos, 🇳🇬</td>
                </tr>
              </tbody>
            </table>
